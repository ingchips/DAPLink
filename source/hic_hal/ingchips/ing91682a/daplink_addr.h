...
#define DAPLINK_ROM_START               0x02002000
#define DAPLINK_ROM_SIZE                0x0007E000 // 512k

#define DAPLINK_RAM_START               0x20000000
#define DAPLINK_RAM_SIZE                0x0000E000 // 32+24 KiB

/* ROM sizes */

#define DAPLINK_ROM_BL_START            0x02002000
#define DAPLINK_ROM_BL_SIZE             0x0000D000

#define DAPLINK_ROM_IF_START            0x0200F000
#define DAPLINK_ROM_IF_SIZE             0x00028000

#define DAPLINK_ROM_CONFIG_USER_START   0x02037000
#define DAPLINK_ROM_CONFIG_USER_SIZE    0x00049000

/* RAM sizes */

#define DAPLINK_RAM_APP_START           0x20000000
#define DAPLINK_RAM_APP_SIZE            0x0000DF00

#define DAPLINK_RAM_SHARED_START        0x2000DF00
