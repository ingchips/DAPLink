...
/* ---------------- DWC2 Configuration ---------------- */
 ...
 #define CONFIG_USB_DWC2_TX1_FIFO_SIZE (32 / 4)
 #define CONFIG_USB_DWC2_TX2_FIFO_SIZE (32 / 4)
 #define CONFIG_USB_DWC2_TX3_FIFO_SIZE (32 / 4)
 #define CONFIG_USB_DWC2_TX4_FIFO_SIZE (32 / 4)
...
#if CONFIG_USE_USB_HOST
/* ---------------- DWC2 Configuration ---------------- */ 
/* largest non-periodic USB packet used / 4 */
 #define CONFIG_USB_DWC2_NPTX_FIFO_SIZE (64 / 4)
/* largest periodic USB packet used / 4 */
 #define CONFIG_USB_DWC2_PTX_FIFO_SIZE (128 / 4)
/*  
(largest USB packet used / 4) + 1 for status information + 1 transfer complete + 
1 location each for Bulk/Control endpoint for handling NAK/NYET scenario 
*/
 #define CONFIG_USB_DWC2_RX_FIFO_SIZE ((288 - CONFIG_USB_DWC2_NPTX_FIFO_SIZE - CONFIG_USB_DWC2_PTX_FIFO_SIZE) / 4)
#endif
...
#define CONFIG_USBHOST_MAX_INTF_ALTSETTINGS 3
#define CONFIG_USBHOST_MAX_ENDPOINTS        5
...
#define CONFIG_USBHOST_REQUEST_BUFFER_LEN 128
#endif
